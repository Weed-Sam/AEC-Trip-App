<?php
    ...
    $pname=$_GET['pname'];
    $_SESSION['place_name'] = $pname;
    $price=$_GET['price'];
    $_SESSION['place_price'] = $price;
   ?>
<html lang="en"><head>
...
<div class="container top-fixed-mob-2" style="margin-top:20px; padding-bottom:5px;">
  <div class="row" style="margin-bottom:10px;">
    <div class="col-9">
      <div class="card-body">
        <h4 style="font-weight:700;"><span id="title"></span>          <div class="landonly"><span id="tripty"></span></div>
        </h4>
      ...
      <div class="row">
        <div class="card" style=" margin-bottom:20px;" id="wayp-1">
          <div class="card-body" style=" padding:20px;">
            <h4 style="font-weight:700; font-size:18px; margin-bottom:10px;"><span id="overview"></span>           <span style="color:#e52b30;">Overview</span></h4>
                        <div style="font-size: 14px; margin-bottom: 10px;" id="lessDiv"> Ultimate <span id="tye"></span>           ... </div>
       ...
       $("#moreDiv").hide();
        ...
        <div class="card" style=" margin-bottom:20px;" id="wayp-2">
          <div class="card-body htdtl_roomtable" style=" padding:20px;">
            <h4 style="font-weight:700; font-size:18px; margin-bottom:20px;"><span id="over"></span>   <span style="color:#e52b30;">Itinerary</span></h4>
                        <div class="maincont open" style="margin-top:20px; border:1px solid #ddd;" id="event">
...
the Bangkok International airport. From here, your flight back home.<br>
        ...
        <a id="wayp-24"></a>
          ...
          <div class="card-body">
            ...
            <div style="font-size:14px;margin-top:1rem" id="includ"><br><!--<ul>
	...
	<li>Return Airport transfers from BKK Airport on a private basis Accommodation On Twin Sharing Basis&nbsp;</li><br>
          ...
          <div class="card-body">
            ...
            <div style="font-size:14px;margin-top:1rem" id="exclud"><br><!-- <ul>
        ...
        <div class="card-body" style="padding:20px;" id="showflightbookingcancelaltion">
          <form action="frmaction.html" method="post" target="actoinfrm">
            <div class="row">
              ...
              <a href="book.php" class="btn btn-danger" style="width: 100%; padding:10px 0px; text-align:center;">Book Now</a>
              </div>
            </div>
          </form>
        </div>
...
for(var i=0;i<places.length;i++){
            ...
            if(pname==placename)
            {
              ...
              document.getElementById("tye").innerHTML=pname;
              document.getElementById("time").innerHTML=obj.duration;
              document.getElementById("cost").innerHTML=obj.price;
              document.getElementById("tripty").innerHTML=obj.trip;
              document.getElementById("overview").innerHTML=pname+" "+obj.duration;
              document.getElementById("over").innerHTML=pname+" "+obj.duration;
              var money = places[i][pname]['price']
              var nod=obj.noofdays;
              for(var k=1;k<=nod;k++)
              {
                let day='day'+k;
                let title = places[i][pname][day]['title']
                let activities = places[i][pname][day]['activities']
              days+=`<div class="maincont open" style="margin-top:20px; border:1px solid #ddd;">
              <div class="mainhead" style="border-bottom:1px solid #ddd; padding:4px;">
                <table width="100%" border="0" cellpadding="0" cellspacing="0">
                  <tbody>
                    <tr>
                    <td colspan="2" align="center" bgcolor="#e52b30" style="padding:10px; font-weight:500; font-size:15px; color:#fff;">Day ${k}</td>
                    <td width="90%" style="padding:10px; font-weight:500; font-size:15px; background-color:#f5f5f5;"><strong>${title}</strong></td>
                    <td style="font-weight:500; font-size:15px; " class="arrow rotate">▼</td>
                  </tr>
                </tbody>
              </table>
              </div>
              <div class="descont" style="padding:20px;font-size:14px;">${activities}</div>
              </div>`;
              
            }
            document.getElementById("event").innerHTML=days;

            var z="<ul>";
              var inclusions=obj.inclusions;
              console.log(inclusions)
              inclusions.forEach((x)=>{
                z+=`<li class="">
                    ${x}
                    <br><br>
                    </li>`
              ...
              z+="</ul>";
              document.getElementById("includ").innerHTML=z;

              var y="<ul>";
              var exclusions=obj.exclusions;
              ...
              y+="</ul>";
              document.getElementById("exclud").innerHTML=y;
        }
}
</script>
